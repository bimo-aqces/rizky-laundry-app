...
export default function PelangganDataPage() {
  ...
  const ok = confirm("Yakin hapus SEMUA data pelanggan?");
  if (!ok) return;
          ...
          <table className=" w-full bg-white rounded shadow">
            <thead className="bg-linear-to-b from bg-yellow-400 to-yellow-600 sticky top-0">
              <tr>
                ...
                <th className="text-gray-800 p-2 text-center border-2 border-gray-600">Berat (kg)</th>
                <th className="text-gray-800 p-2 text-center border-2 border-gray-600">ADT</th>
                <th className="text-gray-800 p-2 text-center border-2 border-gray-600">Paket</th>
                <th className="text-gray-800 p-2 text-center border-2 border-gray-600">Total</th>
                <th className="text-gray-800 p-2 text-center border-2 border-gray-600">Delete</th>
              </tr>
            </thead>
            ...
            <tbody>
              ...
              {data.map((item) => (
                <tr key={item.id} className="border-t">
                  ...
                  <td className="text-gray-800 text-center p-2 border-2 border-gray-600">{item.beratKg ?? "-"}</td>
                  <td className="text-gray-800 text-center p-2 border-2 border-gray-600">{item.adt ?? "-"}</td>
                  <td className="text-gray-800 text-center p-2 border-2 border-gray-600">{item.paket}</td>
                  <td className="text-gray-800 text-center p-2 border-2 border-gray-600">
